...
class User extends BaseModel {
    ...
    constructor(obj) {
        ...
        this.nationality = this.constructor.getValue(obj.nationality);
        this.nationalIdNumber =
          this.constructor.getValue(obj.nationalIdNumber
     || obj.national_id_number);
        this.academicTitle = this.constructor.getValue(obj.academicTitle || obj.academic_title);
    ...
    static mappingInfo() {
        return super.mappingInfo().concat([
            ...
            { name: 'nationality', realName: 'nationality' },
            { name: 'nationalIdNumber', realName: 'national_id_number' },
            { name: 'academicTitle', realName: 'academic_title' },
